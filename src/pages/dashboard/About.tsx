...
import { Info, Code, Award, Target, Globe, Github, Linkedin, ShieldCheck } from 'lucide-react';
    ...
    <div className="space-y-12 pb-20">
      ...
      <section className="space-y-6">
        <Card variant="glass" className="border-l-4 border-l-primary">
          <h3 className="text-2xl font-bold mb-4">Challenge 3: Carbon Footprint Awareness Platform</h3>
      ...
      <section className="space-y-8">
        <h2 className="text-3xl font-bold text-center">Meet the Visionary</h2>
        <Card variant="glass" className="max-w-3xl mx-auto overflow-hidden p-0 border-white/10 group">
          <div className="bg-gradient-to-r from-primary/20 via-blue-500/10 to-primary/20 p-1 md:p-1.5">
            <div className="bg-[#09090b] rounded-[calc(1.5rem-4px)] p-6 md:p-10 flex flex-col md:flex-row items-center gap-10">
              <div className="relative">
                ...
                <div className="absolute -bottom-4 -right-4 h-12 w-12 bg-primary rounded-2xl flex items-center justify-center shadow-xl shadow-primary/20 border-4 border-[#09090b]">
          ...
          <div className="p-4 bg-white/5 text-center border-t border-white/5 backdrop-blur-xl">
